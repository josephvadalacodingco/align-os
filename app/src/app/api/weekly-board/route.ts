...
function buildDemoBoard() {
  ...
  return {
    ...
    tasksByEndeavor: (() => {
      ...
      const demoEndeavorsForScoring = [
        { id: 'music', priorityRank: 1 },
        { id: 'appdev', priorityRank: 2 },
        { id: 'theory', priorityRank: 3 },
      ];

      return groupTasksForBoard(scoreTasks(demoTasks, demoEndeavorsForScoring));
    })(),
    events: demoEvents,
  };
}
